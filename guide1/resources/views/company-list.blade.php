...
@section('content')
  ...
  <!-- Page header -->
    <header class="page-header bg-img" style="background-image: url('https://static.pexels.com/photos/159211/headache-pain-pills-medication-159211.jpeg');">
      ...
      <section class="no-padding-top bg-alt">
        <div class="container">
          <div class="row">
            ...
            <!-- Company detail -->
            <div class="col-xs-12">
              <a class="item-block" href="company-detail.blade.php">
                <header>
