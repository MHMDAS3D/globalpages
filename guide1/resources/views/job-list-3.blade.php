    ...
    <nav class="navbar">
      <div class="container">
        ...
        <div class="pull-right user-login">
          <a class="btn btn-sm btn-primary" href="user-login.blade.php">Login</a> or <a href="user-register.blade.php">register</a>
        </div>
        <!-- END User account -->
        ...
        <ul class="nav-menu">
          ...
          <li>
            ...
            <ul>
              <li><a href="job-list-1.blade.php">Browse jobs - 1</a></li>
              <li><a href="job-list-2.blade.php">Browse jobs - 2</a></li>
              <li><a class="active" href="job-list-3.blade.php">Browse jobs - 3</a></li>
          ...
          <li>
            <a href="#">Company</a>
            <ul>
              <li><a href="company-list.blade.php">Browse companies</a></li>
              <li><a href="company-detail.blade.php">Company detail</a></li>
              <li><a href="company-add.blade.php">Create a company</a></li>
          ...
          <li>
            <a href="#">Pages</a>
            <ul>
              <li><a href="page-blog.blade.php">Blog</a></li>
              <li><a href="page-post.blade.php">Blog-post</a></li>
              <li><a href="page-about.html">About</a></li>
              <li><a href="page-contact.blade.php">Contact</a></li>
              <li><a href="page-faq.blade.php">FAQ</a></li>
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              ...
              <li><a href="page-faq.blade.php">Help center</a></li>
              <li><a href="page-typography.html">Privacy policy</a></li>
              <li><a href="page-contact.blade.php">Contact us</a></li>
            </ul>
          </div>
