...
@section('content')
  ...
  <!-- Page header -->
    <header class="page-header bg-img" style="background-image: url('https://static.pexels.com/photos/442150/pexels-photo-442150.jpeg');">
      <div class="container page-name">
        <h1 class="text-center">Browse markets</h1>
        <p class="lead text-center">Use following search box to find markets that fits you better</p>
      </div>
